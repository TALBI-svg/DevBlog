...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <article class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8 sm:mb-12">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-8 sm:py-6 border-t border-gray-100 flex flex-col-reverse sm:flex-row items-center justify-between gap-3 sm:gap-0">
                <a href="{{ route('posts.index') }}" class="text-gray-600 hover:text-primary-600 font-medium flex items-center transition-colors text-sm sm:text-base">
